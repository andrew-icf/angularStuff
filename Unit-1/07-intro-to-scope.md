...
<!-- between two controllers where one controller (child) is nested inside another controller (parent). -->
...
Answer: I gave it protypical inheritance by declaring an object in the controller. Always have a DOT!
